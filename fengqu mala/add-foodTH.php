        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                if(isset($_FILES['image']['name'])){
                    ...
                    if($image_name!=""){
                        ...
                        if($upload==false){
                            ...
                            header('location:'.SITEURL.'food_order/add-foodTH.php');
                            //stop process
                            die();
                        }
                ...
                if($res2 == TRUE){
                    ...
                    header('location:'.SITEURL.'food_order/manage_foodTH.php');
                }else{
